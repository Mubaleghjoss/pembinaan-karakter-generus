    ...
    `,y=()=>{const a=p(),t=w();if(!a){r.inspector.innerHTML='<p class="pkg-empty-copy">Tambahkan atau pilih frame untuk mulai menyunting.</p>';return}if(!t){r.inspector.innerHTML=`
                <div class="space-y-4" data-inspector-scope="frame">
                    <div>
                        ...
                        <input class="pkg-field w-full" maxlength="120" data-inspector-prop="title" value="${M(a.title)}">
                    </div>
                    <div>
            ...
            `;return}let n="";t.type==="text"?n=`
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    ${b("Latar","backgroundColor",F(t.backgroundColor,"#ffffff"))}
                </div>
                <div>
            ...
            `:t.type==="image"?n=`
                <div>
                    ...
                    <input class="pkg-field w-full" maxlength="160" data-inspector-prop="alt" value="${M(t.alt||"")}">
                </div>
                <div>
