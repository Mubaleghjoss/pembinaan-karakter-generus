            ...
            'sheet_sections' => [
                ...
                [
                    ...
                    'items' => [
                        ...
                        ['label' => '29 Karakter Luhur', 'icon' => 'book', 'url' => route('public.karakter.index'), 'active' => false],
                    ],
                ],
                [
        ...
        <aside 
            ...
            <nav class="flex-1 overflow-y-auto py-4 px-2" @click="if($event.target.closest('a[href]') && window.innerWidth < 1024) sidebarCollapsed = true">
                <div class="space-y-1">
                    ...
                    <!-- 29 Karakter Luhur (referensi bacaan) -->
                    <a href="{{ route('public.karakter.index') }}" target="_blank" rel="noopener" class="nav-item text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-colors">
                        <svg class="nav-icon w-5 h-5 mr-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                        <span class="nav-text">29 Karakter</span>
                    </a>
