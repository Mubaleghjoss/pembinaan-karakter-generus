                            ...
                            <div class="divide-y divide-gray-200 dark:divide-gray-700">
                                @forelse($recentEntries as $entry)
                                    <article class="p-4">
                                        ...
                                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Hal. {{ $entry->page_start }}&ndash;{{ $entry->page_end }} &middot; {{ \App\Support\QuranCatalog::name($entry->surah_start) }} {{ $entry->ayah_start }}&ndash;{{ $entry->ayah_end }}</p>
