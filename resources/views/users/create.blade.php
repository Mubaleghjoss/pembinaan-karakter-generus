...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-6">
        ...
        <p class="mt-1 text-gray-600 dark:text-gray-400">Buat akun admin, pamong, atau pengurus PKG baru</p>
    </div>
        ...
        <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <div class="flex items-center gap-4">
                    <div class="relative">
                        <img id="avatar-preview" src="/images/default-avatar.svg" alt="Avatar Preview" 
            ...
            <div class="rounded-xl border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800/60">
                ...
                <div class="mt-4 grid gap-4 md:grid-cols-2">
                    <div>
                        ...
                        <select name="organizational_team_id" id="organizational_team_id" class="w-full pkg-field @error('organizational_team_id') border-red-500 @enderror">
                            ...
                            @foreach($teams as $team)
                                <option value="{{ $team->id }}" {{ old('organizational_team_id') == $team->id ? 'selected' : '' }}>
                                    {{ $team->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <input type="text" name="organizational_title" id="organizational_title" value="{{ old('organizational_title') }}"
                    ...
                    <div>
                        ...
                        <input type="number" min="0" max="9999" name="organizational_sort_order" id="organizational_sort_order" value="{{ old('organizational_sort_order', 0) }}"
