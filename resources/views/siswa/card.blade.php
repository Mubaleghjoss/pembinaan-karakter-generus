...
@section('title', 'Kartu Siswa - ' . $siswa->nama)
...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-6 flex items-center justify-between">
        ...
        <div class="flex gap-3">
            <a href="{{ route('siswa.index') }}" class="px-4 py-2 bg-gray-500 hover:bg-gray-600 text-white rounded-lg font-medium transition-colors">
                Kembali
            </a>
            <a href="{{ route('siswa.card.print', $siswa) }}" target="_blank" rel="noopener" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-colors inline-flex items-center gap-2">
    ...
    <div class="flex justify-center" id="card-wrapper">
        <div class="id-card">
            ...
            <div class="card-body">
                <!-- Left Side: Photo + Info (38%) -->
                <div class="left-section">
                    <div class="siswa-photo">
                        @if($siswa->foto_path && \Illuminate\Support\Facades\Storage::disk('public')->exists($siswa->foto_path))
    ...
    <div class="mt-6 bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
        ...
        <ul class="text-sm text-blue-700 dark:text-blue-300 space-y-1">
            ...
            <li>Hubungi pamong jika QR Code tidak berfungsi</li>
...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    const qrData = @json($siswa->getQrData());
    
    if (container && qrData) {
        try {
            const QRCode = await window.loadQrCode();
            container.innerHTML = '';
