...
<div class="mx-auto max-w-4xl px-4 py-4 sm:px-6 sm:py-6 lg:px-8">
    <div class="mb-6">
        <a href="{{ route('siswa.materi.index') }}" class="mb-4 flex items-center gap-1 text-blue-600 hover:text-blue-800 dark:text-blue-400">
    ...
    <div class="pkg-card">
        <div class="border-b border-gray-200 p-6 dark:border-gray-700">
            <div class="mb-2 text-sm text-blue-600 dark:text-blue-400">{{ $materi->bulan?->format('F Y') }}</div>
