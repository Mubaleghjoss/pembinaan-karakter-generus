...
<div class="w-full px-4 sm:px-6 lg:px-8 py-8">
    ...
    <!-- Info Box -->
    <div class="pkg-card-soft mb-8 hidden border border-green-200 bg-green-50 p-4 dark:border-green-800 dark:bg-green-900/20 md:block">
        <div class="flex">
    ...
    <details class="pkg-mobile-disclosure pkg-card-soft mb-8 border border-green-200 bg-green-50 p-4 dark:border-green-800 dark:bg-green-900/20 md:hidden" name="mobile-secondary">
        ...
        <ul class="mt-3 list-inside list-disc text-sm text-green-700 dark:text-green-300">
            ...
            <li>File .env tidak disertakan untuk keamanan.</li>
            <li>Proses backup penuh dapat memakan waktu 5-15 menit.</li>
        </ul>
    </details>

    <!-- Petunjuk Pemulihan -->
    <div class="pkg-card-soft mb-8 hidden border border-blue-200 bg-blue-50 p-4 dark:border-blue-800 dark:bg-blue-900/20 md:block">
        <div class="flex">
    ...
    <details class="pkg-mobile-disclosure pkg-card-soft mb-8 border border-blue-200 bg-blue-50 p-4 dark:border-blue-800 dark:bg-blue-900/20 md:hidden" name="mobile-secondary">
        ...
        <ol class="mt-3 list-inside list-decimal space-y-1 text-sm text-blue-700 dark:text-blue-300">
            <li>Extract file ZIP ke folder htdocs/www.</li>
            <li>Salin .env.example menjadi .env dan sesuaikan konfigurasi database.</li>
            <li>Impor SQL, lalu jalankan php artisan storage:link.</li>
        </ol>
    </details>
