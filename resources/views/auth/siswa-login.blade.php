    ...
    <form method="POST" action="{{ route('siswa.login.post') }}" class="space-y-3.5 sm:space-y-4" data-auth-login-form>
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input type="text" name="nis" id="nis" value="{{ old('nis') }}" inputmode="text" autocomplete="username" autocapitalize="none" spellcheck="false" class="form-input pkg-field-icon-left py-2.5" placeholder="Masukkan NIS" required autofocus>
            </div>
        </div>
