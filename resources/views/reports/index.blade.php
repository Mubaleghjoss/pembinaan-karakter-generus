            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tbody class="pkg-table-body divide-y divide-gray-200 dark:divide-gray-700">
                    <template x-for="kelas in classPerformance" :key="kelas.id">
                        <tr>
                            <td data-label="Kelas Sekolah" class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-white pkg-mobile-main"><span x-text="kelas.nama"></span><div class="mt-1 md:hidden text-xs font-semibold text-emerald-600 dark:text-emerald-400" x-text="`${kelas.persentase_kehadiran}% kehadiran`"></div><details class="pkg-mobile-disclosure mt-2 md:hidden" name="mobile-secondary"><summary class="cursor-pointer text-xs font-medium text-indigo-600 dark:text-indigo-400">Rincian kehadiran</summary><div class="mt-2 space-y-1 text-xs text-gray-600 dark:text-gray-300"><p x-text="`Total siswa: ${kelas.total_siswa}`"></p><p x-text="`Hadir: ${kelas.hadir}; Terlambat: ${kelas.terlambat}; Tidak hadir: ${kelas.tidak_hadir}`"></p></div></details></td>
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tbody class="pkg-table-body divide-y divide-gray-200 dark:divide-gray-700">
                    <template x-for="pamong in pamongPerformance" :key="pamong.id"><tr>
                        <td data-label="Pamong" class="pkg-mobile-main px-6 py-4 text-sm font-medium text-gray-900 dark:text-white"><span x-text="pamong.nama"></span><div class="mt-1 md:hidden text-xs font-semibold text-emerald-600 dark:text-emerald-400" x-text="`${pamong.persentase_kehadiran}% kehadiran`"></div><details class="pkg-mobile-disclosure mt-2 md:hidden" name="mobile-secondary"><summary class="cursor-pointer text-xs font-medium text-indigo-600 dark:text-indigo-400">Rincian binaan</summary><div class="mt-2 space-y-1 text-xs text-gray-600 dark:text-gray-300"><p x-text="`Generus binaan: ${pamong.total_siswa}`"></p><p x-text="`Hadir: ${pamong.hadir}; Terlambat: ${pamong.terlambat}; Tidak hadir: ${pamong.tidak_hadir}`"></p></div></details></td>
                    ...
                    <template x-for="(siswa, index) in topStudents" :key="siswa.id">
                        <tr>
                            ...
                            <td data-label="Siswa" class="px-6 py-4 whitespace-nowrap pkg-mobile-main">
                                ...
                                <details class="pkg-mobile-disclosure mt-2 md:hidden" name="mobile-secondary"><summary class="cursor-pointer text-xs font-medium text-indigo-600 dark:text-indigo-400">Rincian siswa</summary><div class="mt-2 space-y-1 text-xs text-gray-600 dark:text-gray-300"><p x-text="`Kelas: ${siswa.school_grade_label || 'Belum dikonfirmasi'}`"></p><p x-text="`Total hadir: ${siswa.total_hadir}`"></p></div></details>
                            </td>
