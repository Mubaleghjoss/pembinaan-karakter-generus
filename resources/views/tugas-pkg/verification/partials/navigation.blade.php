<div class="pkg-task-tabs sticky top-0 z-30 -mx-4 mb-6 max-w-[calc(100%+2rem)] overflow-x-auto overscroll-x-contain border-b border-slate-200/80 bg-white/95 px-4 py-2.5 backdrop-blur dark:border-slate-700/80 dark:bg-slate-950/95 sm:-mx-6 sm:max-w-[calc(100%+3rem)] sm:px-6 sm:py-3 lg:-mx-8 lg:max-w-[calc(100%+4rem)] lg:px-8">
    <nav class="flex min-w-max flex-nowrap gap-2 sm:gap-3" role="tablist" aria-label="Menu Verifikasi Tugas PKG">
