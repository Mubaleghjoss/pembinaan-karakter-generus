...
@section('title', 'Riwayat Karakter - ' . $siswa->nama)
...
<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Riwayat Karakter</h1>
    </div>
        ...
        <div class="lg:col-span-2 pkg-panel p-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-gray-600 dark:text-gray-300">NIS: {{ $siswa->nis }} | Kelas: {{ $siswa->kelas->nama ?? '-' }}</p>
                </div>
            </div>
        </div>
    ...
    <div class="mt-6 flex justify-center gap-3">
        <a href="{{ route('tugas-pkg.check', $siswa) }}" class="pkg-btn-primary px-6 py-3 font-medium flex items-center gap-2">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
            </svg>
            Pamong Bantu Ceklis
        </a>
        <a href="{{ route('tugas-pkg.detail-siswa', ['siswa_id' => $siswa->id]) }}" class="pkg-btn-secondary px-6 py-3 font-medium flex items-center gap-2">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
