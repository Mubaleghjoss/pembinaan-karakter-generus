    ...
    <div class="pkg-hero-shell pkg-home-hero mx-auto max-w-7xl rounded-[2rem] px-5 py-8 sm:px-8 lg:px-10 lg:py-14" data-reveal="zoom">
        <div class="relative z-10">
            ...
            <div class="mt-7 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
                ...
                <a href="{{ route('public.scanner', ['mode' => 'quran']) }}" class="inline-flex w-full items-center justify-center rounded-full border border-emerald-200 bg-emerald-500 px-6 py-3.5 text-base font-bold text-white shadow-2xl transition-all hover-lift hover:bg-emerald-600 dark:border-emerald-400/30 sm:w-auto sm:px-8 sm:py-4 sm:text-lg">
                <svg class="mr-2 h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 5.5A2.5 2.5 0 016.5 3H20v16.5a1.5 1.5 0 00-1.5-1.5H6.5A2.5 2.5 0 014 15.5v-10zM8 7h8m-8 4h6"/>
                </svg>
                Scan Bacaan Al-Qur'an
                </a>
