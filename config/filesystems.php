...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | PRODUCTION FIX: Disk 'public' dikonfigurasi untuk menyimpan langsung
    | ke folder public/storage agar tidak perlu symlink.
    |
    | Set FILESYSTEM_PUBLIC_ROOT di .env untuk production:
