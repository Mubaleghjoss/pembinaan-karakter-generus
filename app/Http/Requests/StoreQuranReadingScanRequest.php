...
class StoreQuranReadingScanRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'sheet_payload' => ['required', 'string', 'max:500', 'regex:/^(?:PKGQURAN:[0-9a-f-]{36}:[A-Za-z0-9]+|PKGQ:[0-9A-F]{32}:[0-9A-F]{32}|PKGQMB:[0-9A-F]{32}:[0-9A-F]{32}|PKGQM:[0-9A-F]{32}:[0-9A-F]{32})$/i'],
